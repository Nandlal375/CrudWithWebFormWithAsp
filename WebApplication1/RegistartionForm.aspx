        ...
        <div>
            <table>
                ...
                <tr>
                    <td>State</td>
                    <td>
                        <asp:DropDownList runat="server" ID="ddlstate" EnableViewState="true">
...
<asp:LinkButton runat="server" ID="LinkButton1" Text="Delete" CommandName="CmdDelet" OnClientClick="return confirm('Are you sure want delete data?');" CommandArgument='<%#Eval("eid")%>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
